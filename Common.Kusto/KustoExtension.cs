namespace Common.Kusto
{
    ...
    public static class KustoExtension
    {
        ...
        {
            return reader[columnIndex] == DBNull.Value ? default : (T) reader[columnIndex];
        }
        ...
        {
            return reader[columnIndex] == DBNull.Value ? default : (T) Enum.Parse(typeof(T), reader.Value<string>(columnIndex), true);
        }
